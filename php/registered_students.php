...
<th>Name</th><th>Email</th><th>Phone</th><th>Adm No</th><th>Y.O.S</th><th>D.O.B</th><th>Gender</th><th>Type</th><th>County</th><th>Town</th>
<th>Adddress</th><th>Category</th><th>Tribe</th><th>Delete</th>
</tr>";
 while ($row = mysqli_fetch_assoc($result)){
     echo"
     <tr>
     <td>".$row['full_name']."</td><td>".$row['email']."</td><td>".$row['phone']."</td><td>".$row['adm_no']."</td><td>".$row['academic_year']."</td>
     <td>".$row['dob']."</td><td>".$row['gender']."</td><td>".$row['student_type']."</td><td>".$row['county']."</td><td>".$row['town']."</td>
     <td>".$row['address']."</td><td>".$row['category']."</td><td>".$row['tribe']."</td><td><a href='../php/delete_stud.php?email=".$row['email']."'><i class='fa fa-trash text-danger fa-fw'></i></a></td>
     </tr>";
 }
echo"</table>
</div>
